...
class TotalAmountPaidFormProvider @Inject() extends Mappings {

  def apply(): Form[String] =
    Form(
      "value" -> text("totalAmountPaid.error.required")
        .verifying(
          firstError(
...
object TotalAmountPaidFormProvider {
  val MaxLength: Int                     = 14
  val NoCommaOrDecimalPointRegex: String = """^[^,.]*$"""
  val WholeNumberRegex: String           = """^[0-9]*$"""
}
